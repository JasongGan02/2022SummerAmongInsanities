...
public class Dagger : MonoBehaviour
{
    ...
    void attack()
    {
        ...
        if (playermovement.facingRight)
        {
            ...
            transform.position = player.transform.position + new Vector3(1f, 0, 0) + player.transform.right * Mathf.Sin(Time.time * frequency + offset) * magnitude;
            transform.Rotate(0, 0, Time.time * speed);
