...
[CreateAssetMenu(fileName = "FireTorch", menuName = "Objects/FireTorch Object")]
public class FireTorchObject : BaseObject, IInventoryObject
{
    [Header("FireTorch Stats")]
    ...
    public virtual GameObject GetSpawnedGameObject() //Spawn the actual game object through calling this function. 
    {
        ...
        (controller as FireTorchController).Initialize(this);
